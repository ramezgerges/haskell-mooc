...
smallestDivisor' n i = if (n `div` i) * i == n then i else smallestDivisor' n (i + 1)
...
biggestPrimeAtMost n = biggestPrimeAtMost' n 2 2

biggestPrimeAtMost' n i best
    | i > n = best
    | isPrime i = biggestPrimeAtMost' n (i + 1) i
    | otherwise = biggestPrimeAtMost' n (i + 1) best
